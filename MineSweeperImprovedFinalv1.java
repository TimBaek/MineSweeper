...
public class MineSweeperImprovedFinalv1
{
	...
	do
	{
		...
		c.drawString ("Enter (p) to play, (i) for instructions or (q) to quit", 50, 450);
    ...
    public static void HS () throws IOException //helper method
    {
	f = new File ("HighScore.txt");
	if (f.exists ())
	{
    ...
    public static void HSStore () throws IOException
    {
	HS ();
	if (f.exists () == false)
	{
    ...
    public static void HSDisplay () throws IOException
    {
	HS ();
	c.clear ();
	int x = 80, y = 100;
	...
	c.drawString ("High Score", 210, 40);
	for (int i = 0 ; i < 10 ; i++)
	{
	    if (highname [i] != null && highscore [i] != 0)
	    {
		...
		c.setColor (Color.orange);
		c.drawString ("Name: " + highname [i], 0, x);
		c.drawString ("Score: " + highscore [i], 0, y);
		x = x + 40;
		y = y + 40;
	    }
	}
    ...
    public static void InsertionSort (int hslength)
    {
    ...
    public static void Play (int x, int y, char C, char level) throws IOException
    {
    ...
    public static void RecursiveEmpty (int h, int l)
    {
	...
	else //if the cell does not exist
	{
	    return;
	}
    }
    ...
    public static void DisplayIntGrid ()
    {
    ...
    {
	c.clear ();
	//c.println ("|WASD - Move| |Enter - Open| |Space Bar - Flag| |K - Save| |Q - Quit|  ");
	//c.println (name);
    ...
    public static void InitializeMine (int n)
    {
	int counter = 0;
	int high;
	int len;
    ...
    public static void InitializeDisplayGrid ()
    {
	for (int i = 0 ; i < length ; i++)
	{
	    c.print (i);
    ...
    public static void SaveGame (char level) throws IOException
    {
	String FileIn = "Save.txt";
	PrintWriter Input = new PrintWriter (new FileWriter (FileIn));
